  ...
  return (
      ...
      <div >
        <div style={whitepaperStyle}>
          ...
          <li className="leading-8 text-center flex-1 p-3 text-lg bg-gray-100 sm:mb-5 md:mr-4"><strong className="block">33% Liquidity for Promotion</strong> <span>Facebook, Google Ads, Reviews and much more!</span></li>
          <li className="leading-8 text-center flex-1 p-3 text-lg bg-gray-100 sm:mb-5 md:mr-2 md:ml-2 "><strong className="block">33% Liquidity for Infrastructure</strong> <span>Computers for automation, staff and other expenses needed to run the company.</span></li>
          <li className="leading-8 text-center flex-1 p-3 text-lg bg-gray-100 sm:mb-5 md:ml-4"><strong className="block">34% Liquidity for Tokenboost</strong><span>We will purchase tokens back every month to boost liquidity and price.</span></li>
          </ul>
          <p className="leading-8 my-6 text-xl">Eventually the Paid promotion and workers / infrastructure liquidity percentages may differ from original. The 34% Liquidity that we will add into to the pool will stay forever until we are at the moon!</p>
