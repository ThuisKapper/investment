  ...
  return (
      ...
      <div >
        <div style={whitepaperStyle}>
          ...
          <ul className="flex">
          <li className="leading-8 text-center flex-1 p-3 mr-4 text-lg bg-gray-100"><strong className="block">33% Liquidity for Promotion</strong> <span>Facebook, Google Ads, Reviews and much more!</span></li>
          <li className="leading-8 text-center flex-1 p-3 mr-2 ml-2 text-lg bg-gray-100"><strong className="block">33% Liquidity for Infrastructure</strong> <span>Computers for automation, staff and other expenses needed to run the company.</span></li>
          <li className="leading-8 text-center flex-1 p-3 ml-4 text-lg bg-gray-100"><strong className="block">34% Liquidity for Tokenboost</strong><span>We will purchase tokens back every month to boost liquidity and price.</span></li>
          </ul>
